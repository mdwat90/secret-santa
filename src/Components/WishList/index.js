  ...
  render() {
    ...
    return (
      <div>
              ...
              {data.length <= 0 ? (
                <Container style={{ height: '10vh', marginTop: '10vh' }}>
                  <Typography variant="h5">
                    {upperCaseName} hasn't added any items to their wishlist yet
                  </Typography>
                </Container>
              ) : (
                [
                  <Typography
                    variant="h5"
                    style={{ color: '#6b6b6b', marginBottom: '3vh' }}
                  >
                    {upperCaseName}'s Wishlist
                  </Typography>,
                  data.map((item, index) => (
                                    ...
                                    <Grid item>
                                      <ButtonBase style={{ borderRadius: 3 }}>
                                        <ShoppingCartOutlinedIcon
                                          ...
                                          onClick={(event) =>
                                            this.openPurchaseModal(event, item)
                                          }
                                        />
                                      </ButtonBase>
                                    </Grid>
        ...
        {/* Purchase Item Modal */}
        <Dialog
          open={this.state.openPurchaseModal}
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              <Typography style={{ textAlign: 'center' }}>
                Do you want to mark this item as purchased?
              </Typography>
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            ...
            <Button
              onClick={() => this.purchaseItem(this.state.itemToUpdate)}
              style={{ color: '#4f92ff' }}
            >
              Confirm
            </Button>
...
const WishListScreen = connect(mapStateToProps, null)(WishList);
