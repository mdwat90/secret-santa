      ...
      <div>
        {this.state.loading ? (
          ...
          <Box className={classes.root}>
                    ...
                    <Grid item md={8} sm={12} xs={12}>
                      <div key={item._id}>
                        <Accordion
                          ...
                          onChange={
                            item.notes ? () => this.expandPanel(item._id) : null
                          }
                        >
                          <AccordionSummary
                            expandIcon={
            ...
            {/* Update Item Modal */}
            <Dialog
              open={this.state.updateItemForm}
            ...
            >
              ...
              <DialogContent>
                ...
                <TextField
                  ...
                  margin="dense"
                  label={
                    this.state.linkError ? 'Must be a valid link' : 'Item link'
                  }
                  type="name"
                  fullWidth
                  className={
                    this.state.link && this.state.linkError
                      ? null
                      : classes.textInput
                  }
            ...
            {/* Delete Item Modal */}
            <Dialog
              open={this.state.deleteItemModal}
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={() => this.deleteFromDB(this.state.itemToDelete)}
                  color="secondary"
                >
                  Delete
                </Button>
...
const ProfileScreen = connect(mapStateToProps, null)(Profile);
